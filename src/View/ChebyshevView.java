...
import Controller.ChebyshevViewController;
 ...
 */
public class ChebyshevView extends JFrame {
    ...
    public ChebyshevView(String titolo) {
        //creo il frame
        super(titolo);
        ...
        nPassaggiB.addActionListener(new ChebyshevViewController(this));
        precisioneB.setHorizontalAlignment(JButton.CENTER);
        precisioneB.addActionListener(new ChebyshevViewController(this));
